...
export function FormManager() {
  ...
  const handleCreateForm = async () => {
    try {
      ...
      const plan = plans.find((p) => p.id === newForm.plan.id);
      setForms((prev) => [
        ...prev,
      ...
      // Reset do formulário
      setNewForm({ plan: { id: "", name: "" }, questions: {} });
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  value={newForm.plan.id}
                  onChange={(e) =>
                    setNewForm((prev) => ({ ...prev, plan: { id: e.target.value, name: "" } }))
                  }
                >
